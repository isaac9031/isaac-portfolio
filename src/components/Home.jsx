...
const Home = () => {  //Home will be behind the NavBar, so you need to comment it out in App.js to see the first changes on the website for home, uncomment Navbar on App.js after you see the change you were expection
  return (
    <div name="home" className='h-fit w-ful bg-gradient-to-b from-black via-black to-blue-800 pt-20'>{/*home will be used for smooth scroll  */} {/*added pt-20 was added to have some sapace from the top where the navbar will be at. Also added h-fit for when the screen is mobile and it changes to h-screen when it is a regular screen*/}
